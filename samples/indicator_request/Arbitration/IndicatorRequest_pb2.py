...
# source: Arbitration/IndicatorRequest.proto
...
IndicatorRequest = _reflection.GeneratedProtocolMessageType('IndicatorRequest', (_message.Message,), dict(
  DESCRIPTOR = _INDICATORREQUEST,
  __module__ = 'Arbitration.IndicatorRequest_pb2'
